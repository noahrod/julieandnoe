for (let sci = 1; sci < 10; sci++) {
  $(function(){
    
      'use strict';
      
      var isDrawing, lastPoint;
      var container    = document.getElementById('scratch-container'+sci),
          canvas1       = document.getElementById('scratch-canvas'+sci),
      ...
      function handleMouseDown(e) {
        ...
        if ($(e.target).attr("id")=="scratch-canvas1") {
          if(!sc1){
            sc1=true;
            opened = opened + 1;
            console.log(opened);
        ...
        if ($(e.target).attr("id")=="scratch-canvas5") {
          if(!sc5){
            sc5=true;
            opened = opened + 1;
            console.log(opened);
        ...
        if ($(e.target).attr("id")=="scratch-canvas9") {
          if(!sc9){
            sc9=true;
            opened = opened + 1;
            console.log(opened);
      ...
      function handleMouseMove(e) {
        ...
        handlePercentage(getFilledInPixels(32),scratched1);
      }
